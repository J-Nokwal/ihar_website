import { closeCommentBox, postComment } from '../store/commentsStore';
...
<div className='SingleCommentBox'>
    <IconButton className='ProfilePhoto'> <Avatar variant='circular' alt="Profile Pic" src={(comment.commentFrom.ProfilePhotoLink !== '') ? comment.commentFrom.ProfilePhotoLink : "https://firebasestorage.googleapis.com/v0/b/ihar-7ab4b.appspot.com/o/profilePics%2F2022-08-13T00%3A30%3A17.633397?alt=media&token=8e93f5b2-8ade-4d27-9b3e-a69d92b9b7d5"} /></IconButton>
